...
You'll use the same bomb for this lab and for [the following PA](pa05-bomb.html).
...
1. In NX, download[^curl] a [binary bomb](http://wilkes.cs.virginia.edu:15213/)
...
8. Once you pass a phase visit [the scoreboard](http://wilkes.cs.virginia.edu:15213/scoreboard) to verify that we saw your success.

[^curl]: If you want, you can download from the command line with the following two lines:
    ````bash
