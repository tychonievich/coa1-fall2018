...
8-bit   16-bit  32-bit  64-bit  calling saved by    notes
------- ------- ------- ------- ------- --------    ----------------------------
al, ah  ax      eax     rax     return  caller      special meaning for multiply and divide instructions
cl, ch  cx      ecx     rcx     arg 4   caller
dl, dh  dx      edx     rdx     arg 3   caller      special meaning for multiply and divide instructions
bl, bh  bx      ebx     rbx             caller
spl     sp      esp     rsp             callee      stack pointer
bpl     bp      ebp     rbp             callee
sil     si      esi     rsi     arg 2   caller
dil     di      edi     rdi     arg 1   caller
r8b     r8w     r8d     r8      arg 5   caller
r9b     r9w     r9d     r9      arg 6   caller
